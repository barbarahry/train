...
//   var addDeleteBtn = $("<input>");
//   addDeleteBtn.attr("scr",  "delete.png");
//   addDeleteBtn.attr ("id","delete");
//   addDeleteBtn.attr ("type","text");
//   addDeleteBtn.attr ("name","image");
...
$(".delete").append(a);
  ...
  trainFrequency + "</td><td>" + tMinutesTillTrain + "</td><td><span class='delete'>" +a+"</span></td></tr>");
